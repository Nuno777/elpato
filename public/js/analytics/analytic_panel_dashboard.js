...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const connectedUsersChartElement = document.getElementById('connectedUsersChart');

    // Verificar se o elemento existe antes de prosseguir
    if (connectedUsersChartElement) {
        const ctx = connectedUsersChartElement.getContext('2d');
        ...
        console.error('ConnectedUsersChart element not found on page.');
    }
});
