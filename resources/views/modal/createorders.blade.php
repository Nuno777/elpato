            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('orders.store', $id_drop) }}" method="POST" enctype="multipart/form-data">
                        ...
                        @if (Auth::check() && isset(Auth::user()->slug))
                        ...
                        @if (isset($address))
                            <input type="hidden" name="address" value="{{ old('address') ?? $address }}" readonly
                                required>
                        @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        @else
                                            ...
                                            <input type="hidden" name="id_drop" class="form-control"
                                                placeholder="Drop Error" readonly required>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea style="resize: none;" type="text" name="comments" class="form-control" placeholder="Comments"
                                            cols="43" rows="5" required>{{ old('notes') ?? $notes }}</textarea>
                        ...
                        @else
                            <div style="margin-top:15px;" class="alert alert-danger alert-icon" role="alert">
                                <i class="mdi mdi-alert"></i>You cannot create orders on drops with problems, please
                                wait
